...
// KlingonMenuNewGame.
//=============================================================================
class KlingonMenuNewGame expands KlingonMenuGame
	localized;
...
function bool ProcessSelection()
{
	...
	ChildMenu = spawn(class'KlingonMenuSinglePlayer', owner);
	HUD(Owner).MainMenu = ChildMenu;
	ChildMenu.ParentMenu = self;
	ChildMenu.PlayerOwner = PlayerOwner;
	KlingonMenuSinglePlayer(ChildMenu).StartMap = StartMap;
	KlingonMenuSinglePlayer(ChildMenu).SinglePlayerOnly = true;
	return true;
}
