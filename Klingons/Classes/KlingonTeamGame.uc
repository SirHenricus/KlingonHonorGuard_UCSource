...
// KlingonTeamGame.
//=============================================================================
class KlingonTeamGame expands KlingonDeathMatch
	localized
	config;
...
function PostBeginPlay()
{
	...
	{
		Teams[i] = Spawn(class'KlingonTeamInfo');
		Teams[i].Size = 0;
		Teams[i].Score = 0;
	}
...
)
{
	...
	{
		Error = "Team für Spieler konnte nicht gefunden werden";
		return None;
	}
...
function bool ChangeTeam(Pawn Other, coerce string[20] PlayerTeam)
{
	local int i, s;
	local pawn APlayer;
	local Klingonteaminfo SmallestTeam;
...
function ValidateTeamName( klingonteaminfo aTeam, Pawn Other )
{
...
defaultproperties
{
     ...
     GameMenuType=Class'Klingons.KlingonMenuTeamGameOptions'
}
